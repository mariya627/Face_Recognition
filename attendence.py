...
class Attendance:
    ...
    def _init_(self, root):
        ...
        # title section
        title_lb1 = Label(bg_img, text="ATTENDANCE PANEL", font=("Algerian", 30, "bold"), bg="white", fg="#003151")
        ...
        # Student id
        studentId_label = Label(left_frame, text="Std-ID:", font=("verdana", 12, "bold"), fg="#003151", bg="white")
        ...
        # Student Roll
        student_roll_label = Label(left_frame, text="Roll.No:", font=("verdana", 12, "bold"), fg="#003151", bg="white")
        ...
        # Studnet Name
        student_name_label = Label(left_frame, text="Std-Name:", font=("verdana", 12, "bold"), fg="#003151", bg="white")
        ...
        # Department
        # dep_label = Label(left_frame,text="Department:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        # time
        time_label = Label(left_frame, text="Time:", font=("verdana", 12, "bold"), fg="#003151", bg="white")
        ...
        # Date
        date_label = Label(left_frame, text="Date:", font=("verdana", 12, "bold"), fg="#003151", bg="white")
        ...
        # Attendance
        student_attend_label = Label(left_frame, text="Attend-status:", font=("verdana", 12, "bold"), fg="#003151",
                                     bg="white")
        ...
        del_btn.grid(row=0, column=2, padx=6, pady=10, sticky=W)
        # show all
        showAll_btn = Button(right_frame, command=self.fetch_data, text="Show All", width=8,
                             font=("verdana", 12, "bold"), fg="white", bg="#003151")
        showAll_btn.grid(row=0, column=3, padx=6, pady=10, sticky=W)
    ...
    def exportCsv(self):
        try:
            ...
            if messagebox.askyesno("Confirmation", "Are you sure you want to save attendance on database?"):
                ...
                cursor.close()
                conn.close()
                messagebox.showinfo("Success", "Data exported to database successfully!")
            else:
                return False
    ...
    def get_cursor_right(self, event=""):
        ...
        if len(data) >= 6:
            ...
            print("Not enough data available in content['values']")
            # Optionally, you could clear the variables or set them to default values
            self.var_id.set("")
            self.var_roll.set("")
            self.var_name.set("")
            self.var_time.set("")
