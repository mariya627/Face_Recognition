...
class Login:
    def _init_(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\PMLS\Downloads\loggiinn.png")

        lb1_bg = Label(self.root, image=self.bg)
        lb1_bg.place(x=-320, y=-50, relwidth=1, relheight=1)

        frame1 = Frame(self.root, bg="#f0f0f0")
        frame1.place(x=760, y=170, width=340, height=450)

        img1 = Image.open(r"C:\Users\PMLS\OneDrive\Documents\AI_Project\Images_GUI\log1.png")
        img1 = img1.resize((100, 100), Image.ANTIALIAS)
        self.photoimage1 = ImageTk.PhotoImage(img1)
        lb1img1 = Label(image=self.photoimage1, bg="#f0f0f0")
        lb1img1.place(x=920, y=70, width=100, height=100)

        get_str = Label(frame1, text="LOGIN", font=("Helvetica", 25, "bold"), fg="#002B53", bg="white")
        get_str.place(x=160, y=20)

        # label1
        username = lb1 = Label(frame1, text="Username:", font=("times new roman", 15, "bold"), fg="#002B53", bg="white")
        username.place(x=60, y=140)

        # entry1
        self.txtuser = ttk.Entry(frame1, font=("times new roman", 15, "bold"))
        self.txtuser.place(x=60, y=170, width=360)

        # label2
        pwd = lb1 = Label(frame1, text="Password:", font=("times new roman", 15, "bold"), fg="#002B53", bg="white")
        pwd.place(x=60, y=210)

        # entry2
        self.txtpwd = ttk.Entry(frame1, font=("times new roman", 15, "bold"))
        self.txtpwd.place(x=60, y=240, width=360)

        # Creating Button Forget
        forgetbtn = Button(frame1, command=self.forget_pwd, text="Forgot Password?", font=("Helvetica", 10, "bold"),
                           bd=0, relief=RIDGE, fg="#007bff", bg="white", activeforeground="orange",
                           activebackground="#002B53")
        forgetbtn.place(x=207, y=270, width=150, height=20)

        # Creating Button Login
        loginbtn = Button(frame1, command=self.login, text="LOGIN", font=("times new roman", 15, "bold"), bd=0,
                          relief=RIDGE, fg="white", bg="#002B53", activeforeground="white", activebackground="#abb9c4",
                          padx=10)
        loginbtn.place(x=60, y=320, width=290, height=35)

        # Creating Button Registration
        reg = lb1 = Label(frame1, text="Don't Have account?", font=("Helvetica", 10, "bold"), fg="black", bg="white")
        reg.place(x=60, y=370, height=20)

        loginbtn = Button(frame1, command=self.reg, text="Register", font=("Helvetica", 10, "bold"), bd=0, relief=RIDGE,
                          fg="#007bff", bg="white", activeforeground="orange", activebackground="#002B53")
        loginbtn.place(x=200, y=370, width=55, height=20)
